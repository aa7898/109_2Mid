...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RadioButton ID="rb1" runat="server"  Text="看書" Font-Size="X-Large"  GroupName="rbg_Interest"/>
            <asp:RadioButton ID="rb2" runat="server"  Text="打電動" Font-Size="X-Large"  GroupName="rbg_Interest" />
            <asp:RadioButton ID="rb3" runat="server"  Text="其他" Font-Size="X-Large"  GroupName="rbg_Interest" /><br />
